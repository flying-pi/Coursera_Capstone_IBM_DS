...
So from the world-cities dataset, I plan to get next features: city name, geographical location, and country name. After that, I plan to add popular venues for each city as new features. 